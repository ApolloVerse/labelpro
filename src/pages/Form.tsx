...
const Form = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsSaving(true);
    // Simula um delay para a animação de "Salvando"
    ...
    <>
      <header className="sticky top-0 z-40 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md border-b border-primary/10">
        <div className="flex items-center p-4 justify-between max-w-2xl mx-auto w-full">
          ...
          <h2 className="text-slate-900 dark:text-slate-100 text-lg font-bold leading-tight tracking-tight flex-1 text-center">Novo Cadastro</h2>
        ...
        {isSuccess && (
          ...
          >
            ...
            >
              ...
              <h2 className="text-xl font-black text-slate-800 dark:text-white uppercase tracking-wider">PRODUTO SALVO!</h2>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
